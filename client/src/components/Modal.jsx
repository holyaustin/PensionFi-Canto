        ...
        <div className="relative px-4 py-4 w-full max-w-md h-full md:h-auto">
          <div className="relative bg-blue-800 opacity-95 rounded-lg shadow border-4 border-purple-700">
            ...
            <div className="p-6 text-center">
              <div className="text-2xl font-semibold text-fuchsia-200">Stake CANTO</div>
              <div className="mt-6">
                <p className="text-xl text-blue-300">Enter the amount to Stake in CANTO:</p>
                <div className="mt-6 flex space-x-4 justify-center">
                  <label className="text-lg text-fuchsia-200" htmlFor="staker">CANTO</label>
